                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          ...
                          <select class="form-control" id="productlist" name="idProductListPO">
                            <?php
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th><center>Harga Nawar</center></th>
                        ...
                        ?>
                          <tr>
                            ...
                            <select>                             
                                    ...
                                    <option value="<?php echo $p['pp_id']; ?>"> <?php echo $p['pp_price']; ?></option>
                            </select>  
                                <?php 
                                  } 
                                ?>
                            ...
                            <td><center><input type="number" class="form-control" name="harga[]" value="<?php echo $data['product_name']; ?>"></center></td>
                            <td>
            ...
            <td>
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo $admin_url; ?>adminweb.php?module=edit_pesan&id_pesan=<?php echo $pro['id_pesan']; ?>&type=updatePembayaranUnpaid">Set As Invoice</a></li>
